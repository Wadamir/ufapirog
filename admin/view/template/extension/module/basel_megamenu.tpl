...
<div class="input clearfix">
        <p><?php echo $text_menu_type; ?></p>
        <select name="menu_type" class="form-control">
                <?php if ($menu_type) { ?>
					<option value="1" selected="selected"><?php echo $text_menu_horizontal; ?></option>
					<option value="0"><?php echo $text_menu_vertical; ?></option>
                <?php } else { ?>
					<option value="1"><?php echo $text_menu_horizontal; ?></option>
					<option value="0" selected="selected"><?php echo $text_menu_vertical; ?></option>
                <?php } ?>
        </select>
</div>
