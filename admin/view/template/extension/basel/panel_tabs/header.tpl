...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <select id="header-select" name="settings[basel][basel_header]" class="form-control">
            <option value="header1" <?php if ($basel_header == 'header1') {
                                        echo ' selected="selected"';
                                    } ?>>Header 1</option>
            <option value="header2" <?php if ($basel_header == 'header2') {
                                        echo ' selected="selected"';
                                    } ?>>Header 2</option>
            <option value="header3" <?php if ($basel_header == 'header3') {
                                        echo ' selected="selected"';
                                    } ?>>Header 3</option>
            <option value="header4" <?php if ($basel_header == 'header4') {
                                        echo ' selected="selected"';
                                    } ?>>Header 4</option>
            <option value="header5" <?php if ($basel_header == 'header5') {
                                        echo ' selected="selected"';
                                    } ?>>Header 5</option>
            <option value="header6" <?php if ($basel_header == 'header6') {
                                        echo ' selected="selected"';
                                    } ?>>Header 6</option>
        </select>
...
<div class="form-group">
    ...
    <div class="col-sm-10 toggle-btn">
        <label><input type="radio" name="settings[basel][top_line_style]" value="0" <?php if ($top_line_style == '0') {
                                                                                        echo ' checked="checked"';
                                                                                    } ?> /><span>Disabled</span></label>
        <label><input type="radio" name="settings[basel][top_line_style]" value="1" <?php if ($top_line_style == '1') {
                                                                                        echo ' checked="checked"';
...
<div class="form-group">
    ...
    <div class="col-sm-10 toggle-btn">
        <label><input type="radio" name="settings[basel][basel_sticky_header]" value="0" <?php if ($basel_sticky_header == '0') {
                                                                                                echo ' checked="checked"';
                                                                                            } ?> /><span>Disabled</span></label>
        <label><input type="radio" name="settings[basel][basel_sticky_header]" value="1" <?php if ($basel_sticky_header == '1') {
                                                                                                echo ' checked="checked"';
                                                                                            } ?> /><span>Enabled</span></label>
    </div>
</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label">Zero Promo Message</label>
    <div class="col-sm-10">
        <?php foreach ($languages as $language) { ?>
            <div class="input-group">
                ...
                <input class="form-control" name="settings[basel][basel_promo0][<?php echo $language['language_id']; ?>]" value="<?php echo isset($basel_promo0[$language['language_id']]) ? $basel_promo0[$language['language_id']] : ''; ?>" />
            </div>
        <?php } ?>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10 toggle-btn">
        <label><input type="radio" name="settings[basel][basel_home_overlay_header]" value="0" <?php if ($basel_home_overlay_header == '0') {
                                                                                                    echo ' checked="checked"';
                                                                                                } ?> /><span>Disabled</span></label>
        <label><input type="radio" name="settings[basel][basel_home_overlay_header]" value="1" <?php if ($basel_home_overlay_header == '1') {
                                                                                                    echo ' checked="checked"';
                                                                                                } ?> /><span>Enabled</span></label>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10 toggle-btn">
        <label><input type="radio" name="settings[basel][header_login]" value="0" <?php if ($header_login == '0') {
                                                                                        echo ' checked="checked"';
                                                                                    } ?> /><span>Disabled</span></label>
        <label><input type="radio" name="settings[basel][header_login]" value="1" <?php if ($header_login == '1') {
                                                                                        echo ' checked="checked"';
                                                                                    } ?> /><span>Enabled</span></label>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10 toggle-btn">
        <label><input type="radio" name="settings[basel][header_search]" value="0" <?php if ($header_search == '0') {
                                                                                        echo ' checked="checked"';
                                                                                    } ?> /><span>Disabled</span></label>
        <label><input type="radio" name="settings[basel][header_search]" value="1" <?php if ($header_search == '1') {
                                                                                        echo ' checked="checked"';
                                                                                    } ?> /><span>Enabled</span></label>
    </div>
</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label">Header Phone Status</label>
    <div class="col-sm-10 toggle-btn">
        <label><input type="radio" name="settings[basel][header_phone]" value="0" <?php if ($header_phone == '0') {
                                                                                        echo ' checked="checked"';
                                                                                    } ?> /><span>Disabled</span></label>
        <label><input type="radio" name="settings[basel][header_phone]" value="1" <?php if ($header_phone == '1') {
                                                                                        echo ' checked="checked"';
                                                                                    } ?> /><span>Enabled</span></label>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10 toggle-btn">
        <label><input type="radio" name="settings[basel][use_custom_links]" class="links-select" value="0" <?php if ($use_custom_links == '0') {
                                                                                                                echo ' checked="checked"';
                                                                                                            } ?> /><span>Disabled</span></label>
        <label><input type="radio" name="settings[basel][use_custom_links]" class="links-select" value="1" <?php if ($use_custom_links == '1') {
                                                                                                                echo ' checked="checked"';
                                                                                                            } ?> /><span>Enabled</span></label>
    </div>
</div>
