            ...
            <div class="panel-wrapper">
                ...
                <div class="panel-left">
                    ...
                    <ul class="menu list-unstyled">
                        <li class="active"><a href="#tab-shop" data-toggle="tab"><i class="fa fa-shopping-cart"></i> <?= $entry_tab_shop ?></a></li>
                        <li><a href="#tab-header" data-toggle="tab"><i class="fa fa-columns"></i> <?= $entry_tab_header ?></a></li>
                        <li><a href="#tab-page-titles" data-toggle="tab"><i class="fa fa-chain"></i> <?= $entry_tab_breadcrumbs ?></a></li>
                        <li><a href="#tab-product-pages" data-toggle="tab"><i class="fa fa-clone"></i> <?= $entry_tab_product_pages ?></a></li>
                        <li><a href="#tab-category-pages" data-toggle="tab"><i class="fa fa-th"></i> <?= $entry_tab_category_pages ?></a></li>
                        <li><a href="#tab-contact-page" data-toggle="tab"><i class="fa fa-envelope-o"></i> <?= $entry_tab_contact_page ?></a></li>
                        <li><a href="#tab-footer" data-toggle="tab"><i class="fa fa-gears"></i> <?= $entry_tab_footer ?></a></li>
                        <li><a href="#tab-notifications" data-toggle="tab"><i class="fa fa-comment-o"></i> <?= $entry_tab_notifications ?></a></li>
                        <li><a href="#tab-styles" data-toggle="tab"><i class="fa fa-paint-brush"></i> <?= $entry_tab_styles ?></a></li>
                        <li><a href="#tab-typography" data-toggle="tab"><i class="fa fa-font"></i> <?= $entry_tab_typography ?></a></li>
                        <li><a href="#tab-image-sizes" data-toggle="tab"><i class="fa fa-image"></i> <?= $entry_tab_image_sizes ?></a></li>
                        <li><a href="#tab-custom-css" data-toggle="tab"><i class="fa fa-css3"></i> <?= $entry_tab_custom_css ?></a></li>
                        <li><a href="#tab-custom-javascript" data-toggle="tab"><i class="fa fa-code"></i> <?= $entry_tab_custom_javascript ?></a></li>
                        <li class="hidden d-none"><a href="#tab-status" data-toggle="tab"><i class="fa fa-toggle-on"></i> <?= $entry_tab_status ?></a></li>
                        <li class="hidden d-none"><a href="#tab-one-click-installer" data-toggle="tab"><i class="fa fa-magic"></i> <?= $entry_tab_one_click_installer ?></a></li>
                    </ul>
                </div><!-- .panel-left ends -->
                ...
                <div class="panel-right">
                    ...
                    <div class="main-content">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane hidden d-none" id="tab-status">
                                <?php require_once('panel_tabs/status.tpl'); ?>
                            </div>

                            <div class="tab-pane hidden d-none" id="tab-one-click-installer">
