...
class ControllerExtensionShippingPickup extends Controller
{
    ...
    public function index()
    {
        ...
        if ($this->config->get('pickup_module_title')) {
            $this->document->setTitle($this->config->get('pickup_module_title'));
        } else {
        ...
        if ($this->config->get('pickup_module_title')) {
            $data['heading_title'] = $this->config->get('pickup_module_title');
        } else {
        ...
        if (isset($this->request->post['pickup_module_title'])) {
            $data['pickup_module_title'] = $this->request->post['pickup_module_title'];
        } else if ($this->config->get('pickup_module_title')) {
            $data['pickup_module_title'] = $this->config->get('pickup_module_title');
        } else {
            $data['pickup_module_title'] = $this->language->get('heading_title');
        }

        if (isset($this->request->post['pickup_address'])) {
            $data['pickup_address'] = $this->request->post['pickup_address'];
        } else if ($this->config->get('pickup_address')) {
            $data['pickup_address'] = $this->config->get('pickup_address');
        } else {
            $data['pickup_address'] = '';
        }
