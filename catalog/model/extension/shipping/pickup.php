...
class ModelExtensionShippingPickup extends Model
{
    function getQuote($address)
    {
        ...
        $data['pickup_module_description'] = ($this->config->get('pickup_module_title')) ? $this->config->get('pickup_module_title') : $this->language->get('heading_title');
        $data['pickup_address'] = ($this->config->get('pickup_address')) ? $this->config->get('pickup_address') : '';
