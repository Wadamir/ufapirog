...
<?php if ($top_line_style) { ?>
    ...
    <!-- $promo_message0 -->
    <?php if (isset($promo_message0) && $promo_message0 !== '') { ?>
        <div class="top_line table text-center promo-message promo-message0">
            <?php echo $promo_message0; ?>
        </div>
    <?php } ?>
    <!-- $promo_message0 end -->
    <?php if (isset($promo_message) && $promo_message !== '' && isset($promo_message2) && $promo_message2 !== '') { ?>
        <div class="top_line table text-center sm-text-center xs-text-center">
            <div class="promo-message">
                <?php if (isset($promo_message) && $promo_message !== '') { ?>
                ...
                <?php } ?>
                <?php if (isset($promo_message2) && $promo_message2 !== '') { ?>
                    <div class="icon-element is_clock">
                        <a class="shortcut-wrapper clock" href="/delivery/">
                            <div class="clock-hover">
                                <span class="clock_time">
