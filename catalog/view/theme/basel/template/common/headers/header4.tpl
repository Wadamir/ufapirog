	...
	<?php if ($top_line_style) { ?>
		<div class="top_line">
			<div class="container <?php echo $top_line_width; ?>">
				<div class="table">
					<div class="table-cell  text-center sm-text-center xs-text-center hidden-xs hidden-sm">
					...
					<div class="table-cell left text-center sm-text-center xs-text-center hidden-lg hidden-md">
						<?php if ($header_phone) { ?>
							<div class="icon-element is_phone">
								<a class="shortcut-wrapper phone" href="tel:<?php echo $telephone; ?>">
									<div class="phone-hover"><i class="icon-phone icon"></i><span class="phone_number"> <?php echo $telephone; ?></span></div>
								</a>
							</div>
						<?php } ?>					
					</div>
		...
		<div class="container <?php echo $main_header_width; ?>">
			<div class="table table-fixed header-main">
				<div class="table-cell hidden-xs hidden-sm">
					<div class="table">
						<div class="table-cell shortcuts hidden-md">
							<div class="font-zero">
								<?php if ($header_phone) { ?>
									<div class="icon-element is_phone">
										<a class="shortcut-wrapper phone" href="tel:<?php echo $telephone; ?>">
