				...
				<div class="row">
					...
					<div class="footer-column col-xs-12 col-sm-6 eq_height">
						...
						<ul class="list-unstyled">
							...
							<?php } ?>
							<li class="hidden"><a href="<?php echo $contact; ?>"><?php echo $text_contact; ?></a></li>
						</ul>
					</div>
					<?php } ?>
					<div class="footer-column col-xs-12 col-sm-6 eq_height">
						...
						<ul class="list-unstyled">
							<li class="hidden"><a href="<?php echo $manufacturer; ?>"><?php echo $text_manufacturer; ?></a></li>
							<li><a href="<?php echo $voucher; ?>"><?php echo $text_voucher; ?></a></li>
							<li class="hidden"><a href="<?php echo $affiliate; ?>"><?php echo $text_affiliate; ?></a></li>
							<li><a href="<?php echo $special; ?>"><?php echo $text_special; ?></a></li>
							<li class="hidden"><a href="<?php echo $sitemap; ?>"><?php echo $text_sitemap; ?></a></li>
							<li><a href="<?php echo $account; ?>"><?php echo $text_account; ?></a></li>
							<li class="hidden"><a href="<?php echo $order; ?>"><?php echo $text_order; ?></a></li>
							...
							<li class="hidden"><a href="<?php echo $newsletter; ?>"><?php echo $text_newsletter; ?></a></li>
						</ul>
					</div>
					<?php } ?>
				</div>
