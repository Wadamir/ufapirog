...
<?php if ($payment_methods) { ?>
    <p class="hidden"><?php echo $text_payment_method; ?></p>
                ...
                <div class="quickcheckout-method">
                    ...
                    <label for="<?php echo $payment_method['code']; ?>">
                        <?php if (!empty($payment_logo[$payment_method['code']])) { ?>
                            <img src="<?php echo $payment_logo[$payment_method['code']]; ?>" alt="<?php echo $payment_method['title']; ?>" />
                        <?php } ?>
...
<?php if ($survey_survey) { ?>
    <div <?php echo $survey_required ? ' class="quickcheckout-content required"' : ' class="quickcheckout-content"'; ?>>
