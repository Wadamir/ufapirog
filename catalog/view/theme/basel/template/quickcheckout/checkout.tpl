...
<div class="container">
  ...
  <div class="row text-center"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-xs-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?>" style="max-width: 800px; margin: 0 auto; padding: 0 15px; text-align: left; float:none">
		...
		<div id="quickcheckout-disable">
		  ...
		  <div class="quickcheckoutleft">
			...
			<div id="shipping-address">
			  <div class="quickcheckout-heading hidden"><i class="fa fa-user"></i> <?php echo $text_checkout_shipping_address; ?></div>
		  ...
		  <div class="quickcheckoutright">
			...
			<div id="shipping-method"<?php echo !$shipping_module ? ' style="display:none;"' : ''; ?>>
			  <div class="quickcheckout-heading hidden"><i class="fa fa-truck"></i> <?php echo $text_checkout_shipping_method; ?></div>
		  ...
		  <?php if ($quickcheckout_layout == '1' || $quickcheckout_layout == '3') { ?>
			<div class="quickcheckoutleft cart-module-holder">
			  <div class="totals-slip">
                  <?php if ($cart_module) { ?>
                  <div id="cart1">
                  	<div class="quickcheckout-content cart-content"></div>
