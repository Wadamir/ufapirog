<?php echo $header; ?>
<div id="ymap" class="map-full-width" style="margin-top:-40px;margin-bottom:40px"><?= $basel_yandex_map ?></div>
<div class="container">
    <ul class="breadcrumb">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="grid-holder margin-b20">
                        ...
                        <div class="item pb-0">
                            <p class="contact-detail">
                                ...
                                <a href="tel:<?php echo $main_phone; ?>" target="_blank"><?php echo $main_phone; ?></a>
                            </p>
                        </div>
                        <?php if ($main_working_hours) { ?>
                            <div class="item pb-0">
                                <p class="contact-detail">
                                    <i class="icon-clock icon"></i>
                                    <?php echo $main_working_hours; ?>
                                </p>
                            </div>
                        <?php } ?>
                    </div>
                    ...
                    <div class="grid-holder margin-b20">
                        ...
                        <div class="item pb-0">
                            <p class="contact-detail">
                                <i class="icon-phone icon"></i>
                                <a href="tel:<?php echo $secondary_phone; ?>" target="_blank"><?php echo $secondary_phone; ?></a>
                            </p>
                        </div>
                        <?php if ($secondary_working_hours) { ?>
                            <div class="item pb-0">
                                <p class="contact-detail">
                                    <i class="icon-clock icon"></i>
                                    <?php echo $secondary_working_hours; ?>
                                </p>
                            </div>
                        <?php } ?>
                    </div>
