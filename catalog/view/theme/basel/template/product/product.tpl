				...
				<div class="table-cell w100 right">
					<div class="inner">
						...
						<?php if ($description && $description != '') { ?>
							<p class="meta_description"><?php echo $description; ?></p>
						<?php } ?>
						<div id="product">
							<?php if ($options) { ?>
								<div class="options">
												...
												<div class="table-cell">
													<select name="option[<?php echo $option['product_option_id']; ?>]" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control">
														...
														<?php foreach ($option['product_option_value'] as $option_value) { ?>
															<option value="<?php echo $option_value['product_option_value_id']; ?>" <?php echo ($option_counter == 0) ? ' selected="selected"' : ''; ?>>
													...
													<div id="input-option<?php echo $option['product_option_id']; ?>">
														...
														<?php foreach ($option['product_option_value'] as $option_value) { ?>
															<div class="checkbox<?php if ($option_value['image']) echo ' has-image'; ?>">
																<label>
																	<input type="checkbox" name="option[<?php echo $option['product_option_id']; ?>][]" value="<?php echo $option_value['product_option_value_id']; ?>" <?php echo ($option_counter == 0) ? ' checked="checked"' : ''; ?> />
						...
						<div class="info-holder">
							...
							<?php } ?>
							<p class="info hidden"><b><?php echo $text_model; ?></b> <?php echo $model; ?></p>
							<?php if ($reward) { ?>
...
<?php } ?>
<?php if ($full_width_tabs) { ?>
<div class="outer-container product-tabs-wrapper hidden">
	<div class="container">
		<?php } else { ?>
