...
$_['text_agree']                     = 'Персональные данные используются для регистрации пользователя, оформления заказов и связи с клиентом. Мною прочитаны и я даю согласие с документом <a href="%s" class="agree"><b>%s</b></a>';
...
$_['error_telephone']                = 'Проверьте правильность номера телефона!';
